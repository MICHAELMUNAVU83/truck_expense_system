defmodule TruckExpenseSystemWeb.UserAuthTest do
  use TruckExpenseSystemWeb.ConnCase, async: true

  alias TruckExpenseSystem.Users
  alias TruckExpenseSystemWeb.UserAuth
  import TruckExpenseSystem.UsersFixtures

  @remember_me_cookie "_truck_expense_system_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TruckExpenseSystemWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TruckExpenseSystemWeb.Endpoint.subscribe(live_socket_id)
